...
import com.onewallet.OneWallet.dataproviders.db.jpa.entities.toOtp
...
open class JpaOtpRepository(private val dbOtpRepository: DBOtpRepository) : OtpRepository {
    ...
    override fun findTopByPhoneNumberOrderByCreatedAtDesc(phoneNumber: String): Otp? {
        return dbOtpRepository.findTopByPhoneNumberOrderByCreatedAtDesc(phoneNumber)?.toOtp()
    }
}